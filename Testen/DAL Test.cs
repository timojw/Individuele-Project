...
namespace Individueel
{
    ...
    public class ProductTest
    {
        ...
        //}
        [TestMethod]
        public void Can_Reviews_Be_Added_To_DB()
        {
            Logic.DTO.ProductReviewDTO review = new Logic.DTO.ProductReviewDTO()
            {
                ReviewerID = 1,
                ProductID = 21,
                Text = "kut beer",
            ...
            DAL.Managers.ReviewDAO dao = new DAL.Managers.ReviewDAO();

            //dao.AddReview(review);

            Assert.IsTrue(dao.GetAllReviews().Count > 0);
        }
